...
SELECT source, article_id, article_name, chunk_type, chunk_text
...
SELECT source, article_id, article_name, chunk_type, snippet(articles_content_fts, 2, '<b>', '</b>', '...', 10) AS highlighted_text
FROM articles_content_fts
...
SELECT source, article_id, article_name, chunk_type, chunk_text, rank
FROM articles_content_fts
